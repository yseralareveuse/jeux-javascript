...
var Page = {  
  ...
  Page.ScoreBarCur = new DrawAreaObj(10.5,1.1,4.5,1,function(){
    ...
    DrawText(text, 'rgb(254,254,254)', '900', 'center', size, left, top);
  ...
  GM.O = function(){
    return new GM.PcObj('rgb(94,94,94)', 1,                
                        [{x:-1,y: 0},
                         {x: 0,y: 0},
                         {x:-1,y: 1}, 
                         {x: 0,y: 1}]);
  ...
  GM.I = function(){
    return new GM.PcObj('rgb(20,28,104)', 2,  
                        [{x:-2,y: 0},
                         {x:-1,y: 0},
                         {x: 0,y: 0},
                         {x: 1,y: 0}]);
  ...
  GM.S = function(){ 
    return new GM.PcObj('rgb(1,215,88)', 2, 
                        [{x: 0,y: 0},
                         {x: 1,y: 0}, 
                         {x:-1,y: 1},
                         {x: 0,y: 1}]);
  ...
  GM.L = function(){
    return new GM.PcObj('rgb(97,78,26)', 4,
                        [{x:-1,y: 0},
                         {x: 0,y: 0},
                         {x: 1,y: 0},
                         {x:-1,y:-1}]);
  ...
  GM.J = function(){
    return new GM.PcObj('rgb(250,234,115)', 4,
                        [{x:-1,y: 0},
                         {x: 0,y: 0},
                         {x: 1,y: 0},
                         {x: 1,y:-1}]);
